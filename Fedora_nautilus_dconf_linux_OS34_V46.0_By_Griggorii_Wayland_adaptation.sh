...
[org/gnome/Weather]
locations=[<(uint32 2, <('London City Airport', 'EGLC', false, [(0.89884456477707964, -0.0087266462599716477)], @a(dd) [])>)>]
...
[org/gnome/software]
check-timestamp=int64 1617773646
first-run=false
install-timestamp=int64 1617723968
update-notification-timestamp=int64 1617773354
